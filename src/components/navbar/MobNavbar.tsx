...
const MobNavbar = () => {
  ...
  return (
    <div  className="flex md:hidden justify-between items-center bg-card  w-full h-[60px] px-4 py-2 relative shadow-lg">
    ...
    {
      open && (
        <div ref={elementRef as any} className='absolute flex items-center justify-between flex-col  top-[60px] right-0 w-[240px]  animation_right bg-card h-[calc(100vh-60px)] shadow-lg pt-8 px-5 pb-8'>
          <div className='flex flex-col  w-full'>
          <MobNavbarLink clickEvent={sidebarCloseHandler} path='/' icon='../home.svg' text='Home' />
          <MobNavbarLink clickEvent={sidebarCloseHandler} path='/' icon='../about.svg' text='About' />
          <MobNavbarLink clickEvent={sidebarCloseHandler} path='/' icon='../location.svg' text='Location' />
          <MobNavbarLink clickEvent={sidebarCloseHandler} path='/' icon='../book.svg' text='Books' />
          <MobNavbarLink clickEvent={sidebarCloseHandler} path='/' icon='../categories.svg' text='Categories' />
          <MobNavbarLink clickEvent={sidebarCloseHandler} path='/' icon='../login.svg' text='Login' />
          <MobNavbarLink clickEvent={sidebarCloseHandler} path='/' icon='../register.svg' text='Sign up' />
          </div>
