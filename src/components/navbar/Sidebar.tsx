...
const Sidebar = ({ closeEvent }: Sidebar) => {
    ...
    return (
        ...
        <div ref={element as RefObject<HTMLDivElement>} className='absolute  top-0 right-0 w-[240px] h-screen max-h-screen  bg-card shadow-lg animation_right flex items-center justify-between flex-col px-5 py-12 pt-16 z-10'>
